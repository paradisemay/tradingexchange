...
Для полного развёртывания системы используйте корневой `docker-compose.yml` в корне репозитория.
Локальный `go/docker-compose.yml` предназначен для изолированного тестирования collector-модуля.
